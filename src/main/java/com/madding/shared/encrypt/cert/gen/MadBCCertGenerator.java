...
public class MadBCCertGenerator {
    ...
    public static X509Certificate createClass3RootCert(KeyPair curKeyPair, PrivateKey caPrivKey,
                                                       X509Certificate caCert) throws Exception {
        return BCCertGenerator.getIns().createClass3RootCert(curKeyPair, caPrivKey, caCert);
    }

    public static X509Certificate createClass1CaCert(KeyPair curKeyPair, PrivateKey caPrivKey,
                                                     X509Certificate caCert) throws Exception {
